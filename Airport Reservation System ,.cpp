...
int tDate = 5; int tMonth = 1; int tYear = 2021; //today's date
...
int type()
{
	...
	do
	{
		...
		cout<<"\t\t"<<"                      *          |                                       |             *"<<endl;
		cout<<"\t\t"<<"                     *           |     Wellcome To Islamabad Airport     |              *"<<endl;
		cout<<"\t\t"<<"                    *            |         reservation system            |               *"<<endl;
		cout<<"\t\t"<<"                   *             |_______________________________________|                 *"<<endl;
		cout<<"\t\t"<<"                   *                           MAIN MANU                                   *"<<endl;
		cout<<"\t\t"<<"                    *                      ENTER YOUR CHOICE                              *"<<endl;
		cout<<"\t\t"<<"                     *                 PRESS 1 FOR LOCAL BOOKING                         *"<<endl;
		cout<<"\t\t"<<"                      *             PRESS 2 FOR INTER NATIONA BOOKING                   *"<<endl;
		cout<<"\t\t"<<"                        *           PRESS 3 FOR SEARCH OF ALL FLIGHTS                  *"<<endl;
		cout<<"\t\t"<<"                         **************************************************************"<<endl;
...
void ticket()
{
	...
	cout << "" << "*/*/       |islamabad international  airport reservation |          */*/" << endl;
...
bool runagain()
{
	...
	if (again == 'q' || again == 'Q')
	{
		...
		cout << "\t\t" << "                             |     islamabad internation airport    |          " << endl;
		cout << "                                       |______________________________________|         " << endl;
		cout << "\t\t" << "           ******************************************************************" << endl << endl;
		cout << "\t\t\t\t\t\t THANK YOU********** Please do Come Visit \n\n\n" << endl;
		cout << "\t\t" << "           *****************************************************************" << endl << endl;
		system("pause");
	}
	return run;
